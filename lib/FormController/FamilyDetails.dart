                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        buildFormField('Number Of Family Member', _noOfFamilyMember),
                        const SizedBox(height: 10),
                        ...
                        const SizedBox(height: 10),
                        buildFormField('No. of Dependents', _noOfDependent),
                        const SizedBox(height: 10),
                        buildFormField('Father First Name', _fatherFirstName),
                        const SizedBox(height: 10),
                        buildFormField('Father Middle Name', _fatherMiddleName),
                        const SizedBox(height: 10),
                        buildFormField('Father Last Name', _fatherLastName),
                        const SizedBox(height: 10),
                        buildFormField('Mother First Name', _motherFirstName),
                        const SizedBox(height: 10),
                        buildFormField('Mother Middle Name', _motherMiddleName),
                        const SizedBox(height: 10),
                        buildFormField('Mother Last Name', _motherLastName),
                        const SizedBox(height: 10),
                        buildFormField('Spouse First Name', _spouseFirstName),
                        const SizedBox(height: 10),
                        buildFormField('Spouse Middle Name', _spouseMiddleName),
                        const SizedBox(height: 10),
                        buildFormField('Spouse Last Name', _spouseLastName),                     
...
void saveFamilyDetailsToSQLite() async {
  ...
  await db.insert(
    ...
    conflictAlgorithm: ConflictAlgorithm.replace, // Use the conflict algorithm as per your requirement
  );
