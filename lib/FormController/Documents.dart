              ...
              children: [
                CollapsibleSection(
                  ...
                  content: Column(
                    children: [
                      buildDropdownField(
                          'Document Type', ['Adhar', 'Pan'], _documentType),
  ...
  Widget _buildUploadDocumentView() {
    ...
    return Padding(
      padding: const EdgeInsets.fromLTRB(
          20.0, 10.0, 20.0, 10.0), // Adjust the values as needed
      child: Container(
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      _extractFileName(
                          document['DocumentPath']), // Use document name here
...
// Call the method to get documents for a specific client
  void fetchDocumentsForClient(String clientId) async {
    List<Map<String, dynamic>> documents =
        await getDocumentsForClient(clientId);
  ...
  Future<List<Map<String, dynamic>>> getDocumentsForClient(
