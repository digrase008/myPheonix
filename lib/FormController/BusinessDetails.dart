                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 8),
                              buildFormField(
                                  'Business Vintage', _businessVintage),
                              const SizedBox(height: 8),
                              buildFormField('Overall Business Experiance',
                                  _businessExpirience),
                              const SizedBox(height: 8),
                              buildDropdownField(
                              ...
                              buildDropdownField(
                                  ...
                                  ['Category 1', 'Category 2', 'Categoty 3'],
                                  _businessPremisesStatus),
                              const SizedBox(height: 12),
                              BulletSelectionWidget(
                                question: 'Rental Agreement Availablity',
                                options: const ['YES', 'NO'],
                                selectionController: _agreeementAvailablity,
                              ),
                              const SizedBox(height: 12),
                              buildDateOfBirthField(
                                  context,
                                  'Rental Agreement Valid Upto',
                                  _businessRentalValidity)
  ...
  void getBusinessDetailsForUserFromSQLite(String userId) async {
    ...
    if (businessData.isNotEmpty) {
      setState(() {
        ...
        _businessClassification.text =
            businessData[0]['BusinessClassification'] ?? '';
        ...
        _businessPremisesStatus.text =
            businessData[0]['BusinessPremises'] ?? '';
        _agreeementAvailablity.text =
            businessData[0]['AgreementAvailable'] ?? '';
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text('Business details saved successfully!'),
          actions: <Widget>[
            TextButton(
              onPressed: () {
