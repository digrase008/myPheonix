                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 8),
                        buildDropdownField('Product', ['Product 1', 'Product 2', 'Product 3'], _product),
                        const SizedBox(height: 8),
                        buildDropdownField('Application Categoty', ['Category 1', 'Category 2', 'Categoty 3'], _applicationCategoty),
                        const SizedBox(height: 8),
                        DropDownWithItem(title: 'Applied Loan Amount', items: const ['INR', 'USD', 'EUR'],controller: _appliedLoanAmount),
                        const SizedBox(height: 12),
                        buildFormField('Applied Tenure(Months)', _appliedTenure),
                        const SizedBox(height: 12),
                        buildFormField('End use of the Loan', _endUseOfTheLoan),                    
