                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              buildDropdownField(
                                  'Property Type',
                                  ['Legal', 'Illegal', 'Rented'],
                                  _propertyType),
                              const SizedBox(height: 8),
                              buildDateOfBirthField(context,
                                  'Date Of Registration', _dateOfRegitration),
                              const SizedBox(height: 8),
                              buildFormField('Asset ID', _assetID),
                              const SizedBox(height: 8),
                              buildFormField(
                                  'Sub registrar/SRO', _subRegitration),
                              const SizedBox(height: 8),
                              buildFormField(
                                  'Extent of the Property', _extentOfProperty),
                              UploadPhotoField(
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text('Property details saved successfully!'),
          actions: <Widget>[
            TextButton(
              onPressed: () {
